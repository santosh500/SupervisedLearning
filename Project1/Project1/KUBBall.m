...
P = importdata('featureMat_Latex_test_bioLBP.mat');
P(:,1) = [];

P1 = importdata('featureMat_liv_test_bioLBP.mat');
P1(:,1) = [];
...
gelatineDataTest = importdata('featureMat_Gelatine_test_bioLBP.mat');
gelatineDataTest(:,1) = [];
...
%#5
lossReal = loss(Md2,P1,realReshape);
%lossGelatine
lossGelatine= loss(Md2,gelatineDataTest,fakeReshape);
%resubstitution loss Gelatine
